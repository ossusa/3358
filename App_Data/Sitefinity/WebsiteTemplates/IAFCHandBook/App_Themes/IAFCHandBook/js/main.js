...
$(document).ready(function () {
    ...
    $('.header__sub_list:nth-of-type(1)').click(function() {
        $('.header__sub_list:nth-of-type(1)').css({"color": "#5591AA", "text-shadow": "1px 0 0 #5591AA"});
    ...
    $('.header__sub_list:nth-of-type(2)').click(function() {
        $('.header__sub_list:nth-of-type(2)').css({"color": "#BDA15F", "text-shadow": "1px 0 0 #BDA15F"});
    ...
    $('.header__sub_list:nth-of-type(3)').click(function() {
        $('.header__sub_list:nth-of-type(3)').css({"color": "#73AA56", "text-shadow": "1px 0 0 #73AA56"});
    ...
    $('.header__sub_list:nth-of-type(4)').click(function() {
        $('.header__sub_list:nth-of-type(4)').css({"color": "#CF794A", "text-shadow": "1px 0 0 #CF794A"});
