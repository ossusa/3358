        ...
        $.fn.flipster = function(options) {
            ...
            return this.each(function() {
                ...
                function init() {
                    ...
                    self.addClass([
                        classes.main, (transformSupport ? 'flipster--transform' : ' flipster--no-transform'), (settings.style ? 'flipster--' + settings.style : ''), (settings.click ? 'flipster--click' : '')
                    ].join(' '));
